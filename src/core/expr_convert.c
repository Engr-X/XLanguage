...
void expr_convert(struct token_stack* postfix, const struct variable_table* variable_table, const struct operation_table* operation_table,
        ...
        switch (p -> raw_type)
        {
            ...
            case TT_OPERATION:
            {
                ...
                else if (p -> params_count == 1)
                {
                    ...
                    {
                        op = operation_get(operation_table, first_type, p -> token, second_type);
            ...
            case TT_FUNCTION:
            {
                ...
                const uint16_t params_count = p -> params_count;
                ...
                {
                    func = function_get(function_table, p -> token, buffer);
